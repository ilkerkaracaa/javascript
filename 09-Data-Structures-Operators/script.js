...
console.log('Ilker Karaca'.split(' '));

const [firstName, lastName] = 'Ilker Karaca'.split(' ');
...
capitalizeName('ilker karaca');

// Padding
const message = 'Go to gate 23!';
console.log(message.padStart(25, '+').padEnd(35, '+'));
console.log('Ilker'.padStart(25, '+'));
console.log('Ilker'.padEnd(25, '+'));
console.log('Ilker'.padEnd(25, '+').padStart(35, '+'));
...
// Comparing emails
const email = 'hello@ilker.io';
const loginEmail = '  Hello@Ilker.Io \n';
...
console.log(new String('ilker'));
console.log(typeof new String('ilker'));
console.log(typeof new String('ilker').slice(1));
...
console.log(new Set('ilkerkaraca').size);
...
asfasfasfascount.split('-')[1].toUpperCase()
...
document.querySelector('button').addEventListener('click', function () {
  ...
  for (let count of arr) {
    let strings = `${count.split('_')[0].toLowerCase()}${count
      .split('_')[1]
      .charAt(0)
      .toUpperCase()}${count.split('_')[1].slice(1).toLowerCase()}`
      .trim(' ')
      .padEnd(20);
    console.log(`${strings}${'OK'.repeat(i)}`);
    i++;
  }
});
