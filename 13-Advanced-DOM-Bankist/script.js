...
console.log(allButtons); // returns an HTMLCollection, which is a live collection, meaning that it is updated automatically when the DOM changes
...
// header.before(message); // adds the element as a sibling before the header element
// header.after(message); // adds the element as a sibling after the header element

// Delete elements
document
  .querySelector('.btn--close-cookie')
  .addEventListener('click', function () {
    // message.remove(); // removes the element
    message.parentElement.removeChild(message); // removes the element
  });
